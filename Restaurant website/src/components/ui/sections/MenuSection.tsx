    ...
    <Section id="menu">
      <div className="w-full max-w-5xl space-y-12 px-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-4">
          ...
          <button className="text-[10px] uppercase tracking-[0.3em] text-[#d4a853] border border-[#d4a853]/20 bg-transparent hover:bg-[#d4a853]/10 px-5 py-2 rounded-sm transition-all duration-300 cursor-pointer">
            Download PDF
          </button>
        </div>
      </div>
